...
<div class="mdl-cell mdl-cell--8-col-desktop mdl-cell--12-col-tablet mdl-cell--8-col-phone">            </div>
                <div class="mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title">
                        <h1 class="mdl-card__title-text">View Service</h1>
                    </div>
                    <div class="mdl-card__supporting-text no-padding">
                        <table class="mdl-data-table mdl-js-data-table stripped-table">
                            ...
                            <tr>
                                ...
                                <td class="mdl-data-table__cell--non-numeric">{{$value->s_price}}</td>
                                <td><img src="{{asset('uploads/'.$value->image)}}" alt=""></td>
                                <td class="mdl-data-table__cell--non-numeric"><span class="label label--mini color--light blue"><a href="/updateservice/{{$value->id}}"> Update</a></span> </td>
                            </tr>
                            @endforeach
                            </tbody>
                        </table>
