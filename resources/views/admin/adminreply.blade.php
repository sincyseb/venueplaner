            ...
            <!-- <div class="mdl-cell mdl-cell--5-col-desktop mdl-cell--5-col-tablet mdl-cell--4-col-phone"> -->
                <div class="mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title">
                        <h5 class="mdl-card__title-text text-color--white">Update Venue</h5>
                    </div>
                    <div class="mdl-card__supporting-text">
                    @foreach($result as $value)
                        <form class="form form--basic" method="post" action="/venueupdate/{{$value->id}}"  enctype="multipart/form-data">
                            @csrf
                            <div class="mdl-grid">
                                ...
                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select full-size">
                                        <input class="mdl-textfield__input" type="text" value="{{$value->district}}" name="district"id="location" readonly tabIndex="-1"/>
                                    ...
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                        <input class="mdl-textfield__input" type="text"  name="location" value="{{$value->location}}" id="location">
                                        <label class="mdl-textfield__label" for="location"></label>
                                    </div>

                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                        <input class="mdl-textfield__input" type="text"  name="venue" value="{{$value->venuetype}}" id="venue">
                                        <label class="mdl-textfield__label" for="venue"></label>
                                    </div>
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                        <input class="mdl-textfield__input" type="text" name="price" value="{{$value->price}}" id="price">
